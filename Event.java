 ...
 */
 public class Event {
    ...
    String execute(){
   	...
   	String events = fullEvent.substring(fullEvent.indexOf('[')+1, fullEvent.indexOf(']'));
    ...
    void determineType(String eventName){
        ...
        else if(eventName.contains("Death"))
            this.deathEvent();
    ...
    private void deathEvent(){
   	System.out.println(fullEvent.substring(fullEvent.indexOf(":")+1));
